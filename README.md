...
Browser build for [_node-ytdl-core_](https://github.com/ybd-project/ytdl-core): YouTube video downloader in pure javascript
...
```html
  <script src="//cdn.jsdelivr.net/npm/@warren-bank/browser-ytdl-core@6.0.8-ybd-project.1/dist/es2020/ytdl-core.js"></script>
```
...
* license for [_node-ytdl-core_](https://github.com/ybd-project/ytdl-core) is [MIT](https://github.com/ybd-project/ytdl-core/blob/latest/LICENSE)
* license for [_browser-ytdl-core_](https://github.com/warren-bank/browser-ytdl-core/releases/tag/v6.0.8-ybd-project.1) is [GPL-2.0](https://github.com/warren-bank/browser-ytdl-core/blob/v6.0.8-ybd-project.1/LICENSE.txt)
